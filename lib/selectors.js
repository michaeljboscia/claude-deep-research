...
const SELECTORS = {
  ...
  // Indicator that the user is logged in (must be specific to the
  // authenticated chat UI — NOT generic elements like 'nav' that
  // appear on marketing/login pages too)
  loggedIn: [
    '[data-testid="chat-input"]',
    'div[contenteditable="true"][translate="no"]',
    'button[aria-label="Send Message"]',
